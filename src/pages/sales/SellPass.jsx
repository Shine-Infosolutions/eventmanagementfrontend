    ...
    <div className="min-h-screen bg-gray-50">
      <div className="w-full">
        <div className="bg-white border-b border-gray-200 px-4 sm:px-8 py-4 sm:py-6">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">Sell Pass</h1>
          <p className="text-gray-600 mt-2 text-sm sm:text-base">Create new event pass for customers</p>
        </div>
        ...
        <div className="p-4 sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
            ...
            {/* Pass Type Selection */}
            <div>
              <label className="block text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Select Pass Type</label>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {passTypes.map((passType) => (
                  <div
                    key={passType._id}
                    className={`relative border-2 rounded-xl p-4 sm:p-6 cursor-pointer transition-all hover:shadow-md ${
                  ...
                  >
                    ...
                    <div className="text-center">
                      <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">{passType.name}</h3>
                      <div className="text-2xl sm:text-3xl font-bold text-green-600 mb-2">₹{passType.price}</div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-4 sm:p-6">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    <div className="text-2xl sm:text-3xl font-bold text-green-600">₹{selectedPass.price}</div>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 sm:py-4 px-4 sm:px-6 rounded-xl font-semibold text-base sm:text-lg hover:from-blue-700 hover:to-blue-800 focus:ring-4 focus:ring-blue-200 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              {loading ? (
